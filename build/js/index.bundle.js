...
document.addEventListener("DOMContentLoaded", () => {
  ...
  tasks.forEach((el) => {
    const taskItem = `<div class="main__list-item main__list-sort" data-id="${el.id}">
    <input class="done-btn" type="checkbox" onclick="doneTask(this)" />
    <p class="task-name">${el.text}</p>
    <span class="date-info">${el.date}</span>
    <div class="important">
      <svg
        class="star-important ${el.isImportant && "star-important-checked"}"
...
function createTask() {
  ...
  const taskItem = `<div class="main__list-item main__list-sort" data-id="${id}">
  <input class="done-btn" type="checkbox" onclick="doneTask(this)" />
